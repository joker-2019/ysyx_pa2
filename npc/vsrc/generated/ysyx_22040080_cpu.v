...
`endif // RANDOMIZE_REG_INIT
  ...
  always @(posedge clock) begin
    if (reset) begin // @[scala/ysyx/ysyx_22040080_pc.scala 82:30]
      pcReg <= 32'h30000000; // @[scala/ysyx/ysyx_22040080_pc.scala 82:30]
    ...
    if (reset) begin // @[scala/ysyx/ysyx_22040080_pc.scala 84:30]
      tracePcReg <= 32'h30000000; // @[scala/ysyx/ysyx_22040080_pc.scala 84:30]
    end else if (io_pc_update_en | io_access_fault) begin // @[scala/ysyx/ysyx_22040080_pc.scala 111:44]
      if (!(io_access_fault)) begin // @[scala/ysyx/ysyx_22040080_pc.scala 112:27]
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [31:0] araddrReg; // @[scala/ysyx/ysyx_22040080_ifu.scala 41:29]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[scala/ysyx/ysyx_22040080_ifu.scala 41:29]
      araddrReg <= 32'h30000000; // @[scala/ysyx/ysyx_22040080_ifu.scala 41:29]
