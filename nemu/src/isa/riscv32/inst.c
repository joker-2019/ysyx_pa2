...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = (int64_t)((int64_t)src1 * (int64_t)src2) >> 32);// 64位相乘，保留高为32
  ...
  INSTPAT("??????? ????? ????? 110 ????? 11000 11", bltu   , B, if (src1 < src2)  s->dnpc = s->pc + imm); //无符号小于时的分支
